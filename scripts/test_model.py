...
class truck:
    ...
    def calculateCorners(self, pointFront, th1, th2):
        #print "theta1:", th1, "cos:", cos(th1), "sin", sin(th1)
        #print "theta2:", th2, "cos:", cos(th2), "sin", sin(th2), '\n'
        ...
        #print "theta1:", th1, cos(th1), sin(th1)
        ...
        #print '\n', "theta1:", th1, "cos:", cos(th1), "sin", sin(th1)
        #print "theta2:", th2, "cos:", cos(th2), "sin", sin(th2)
...
if __name__ == '__main__':
    ...
    #truck.calculateCorners(Point(200, 200), radians(0), radians(0))
